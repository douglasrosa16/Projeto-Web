    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12" >
                ...
                <tbody>
                <tr>
                    <th scope="row"><?php echo $marcas->getId();?></th>
                    <td><?php echo $marcas->getMarca();?></td>   
                    <td></td>     
                </tr>
                </tbody>
                </table>
                <div class="input-group-append">
                       <a class="btn btn-primary" href="listaMarcas.php" role="button">Voltar</a>
